...
- (void)speakText:(NSString*)aTextToSpeak {
    ...
    NSLog(@"There are %ld utterances to speak", (long)myExpectedUtterances);
...
- (void) cancelAudioSession {
    ...
    {
        NSLog(@"AVSpeechSynthesizerFacade::cancelAudioSession attempt number %ld", (long)[self myDeactivationAttempts]);
        ...
        else
        {
            ...
            NSLog(@"Deactivating the AVAudioSession session request %ld in 2 seconds",(long)[self myDeactivationAttempts]);
...
- (void)speechSynthesizer:(AVSpeechSynthesizer *)synthesizer didFinishSpeechUtterance:(AVSpeechUtterance *)utterance
{
    ...
    {
        NSLog(@"AVSpeechSynthesizerFacade::didFinishSpeechUtterance - not canceling audio session yet because there are %ld utterances pending", (long)[self myExpectedUtterances]);
    }
